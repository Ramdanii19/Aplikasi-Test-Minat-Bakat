...
<!-- jQuery -->
<link rel="stylesheet" href="{{ asset('AdminLTE/plugins/jquery/jquery.min.js') }}">
<!-- Bootstrap 4 -->
<link rel="stylesheet" href="{{ asset('AdminLTE/plugins/bootstrap/js/bootstrap.bundle.min.js') }}">
<!-- AdminLTE App -->
